(() => {
  ...
  const c = [
      { key: a.Required, dict: { en: 'The field is required' } },
      { key: a.Email, dict: { en: 'Email has invalid format' } },
      {
        key: a.MaxLength,
      ...
      { key: a.Number, dict: { en: 'Value should be a number' } },
      {
        key: a.MaxNumber,
  ...
  class b {
    constructor(e, t, s) {
      i(this, 'form', null),
        ...
        i(this, 'errors', {}),
        i(this, 'isValid', !1),
        i(this, 'isSubmitted', !1),
        i(this, 'globalConfig', g),
        i(this, 'errorLabels', {}),
        i(this, 'successLabels', {}),
        i(this, 'eventListeners', []),
        i(this, 'dictLocale', c),
        i(this, 'currentLocale', 'en'),
        i(this, 'customStyleTags', {}),
        i(this, 'onSuccessCallback'),
        i(this, 'onFailCallback'),
        i(this, 'onValidateCallback'),
        i(this, 'tooltips', []),
        i(this, 'lastScrollPosition'),
        i(this, 'isScrollTick'),
        i(this, 'fieldIds', new Map()),
        i(this, 'getKeyByFieldSelector', e => this.fieldIds.get(e)),
    ...
    initialize(e, i, t) {
      ...
      if (
        ((this.globalConfig = { ...g, ...i }),
        t && (this.dictLocale = [...t, ...c]),
        this.isTooltip())
      ) {
    ...
    validateFieldRule(e, i, n, d = !1) {
      const c = n.value,
        h = this.getElemValue(i);
      var f;
      if (n.plugin)
        n.plugin(h, this.getCompatibleFields()) || this.setFieldInvalid(e, n);
      else
        switch (n.rule) {
          case a.Required:
            (e => {
            ...
            })(h) && this.setFieldInvalid(e, n);
            break;
          case a.Email:
            if (o(h)) break;
            (f = h), t.test(f) || this.setFieldInvalid(e, n);
            break;
          case a.MaxLength:
            if (void 0 === c) {
              console.error(
                `Value for ${n.rule} rule for [${e}] field is not defined. The field will be always invalid.`,
              ),
            ...
            if ('number' != typeof c) {
              console.error(
                `Value for ${n.rule} rule for [${e}] should be a number. The field will be always invalid.`,
              ),
                this.setFieldInvalid(e, n);
              break;
            }
            if (o(h)) break;
            ((e, i) => e.length > i)(h, c) && this.setFieldInvalid(e, n);
            break;
          case a.MinLength:
            if (void 0 === c) {
              console.error(
          ...
          case a.Password:
            if (o(h)) break;
            (e => l.test(e))(h) || this.setFieldInvalid(e, n);
            break;
          case a.StrongPassword:
            if (o(h)) break;
            (e => r.test(e))(h) || this.setFieldInvalid(e, n);
            break;
          case a.Number:
            if (o(h)) break;
            (e => 'string' == typeof e && !isNaN(+e) && !isNaN(parseFloat(e)))(
              h,
            ) || this.setFieldInvalid(e, n);
            break;
          case a.Integer:
            if (o(h)) break;
            (e => s.test(e))(h) || this.setFieldInvalid(e, n);
            break;
          case a.MaxNumber: {
            if (void 0 === c) {
              console.error(
            ...
            if ('number' != typeof c) {
              console.error(
                `Value for ${n.rule} rule for [${e}] field should be a number. The field will be always invalid.`,
              ),
                this.setFieldInvalid(e, n);
              break;
            }
          ...
          case a.CustomRegexp: {
            if (void 0 === c)
              return (
                console.error(
                  `Value for ${n.rule} rule for [${e}] field is not defined. This field will be always invalid.`,
                ),
                void this.setFieldInvalid(e, n)
              );
            let i;
            try {
              i = new RegExp(c);
              ...
              console.error(
                `Value for ${n.rule} rule for [${e}] should be a valid regexp. This field will be always invalid.`,
              ),
                this.setFieldInvalid(e, n);
              break;
            }
          ...
          case a.Files: {
            ...
            if ('object' != typeof c)
              return (
                console.error(
                  `Value for ${n.rule} rule for [${e}] field should be an object. This field will be always invalid.`,
                ),
                void this.setFieldInvalid(e, n)
              );
            const i = c.files;
            if ('object' != typeof i)
              return (
                console.error(
                  `Value for ${n.rule} rule for [${e}] field should be an object with files array. This field will be always invalid.`,
                ),
                void this.setFieldInvalid(e, n)
              );
            const t = (e, i) => {
          ...
          default: {
            ...
            const i = n.validator(h, this.getCompatibleFields());
            if (
              ('boolean' != typeof i &&
                'function' != typeof i &&
                console.error(
        ...
        this.validate(i).finally(() => {
          ...
          this.globalConfig.lockForm && this.unlockForm(),
            this.isValid
              ...
              : null == (t = this.onFailCallback) ||
                t.call(this, this.getCompatibleFields(), this.groupFields);
        })
      );
    }
    setForm(e) {
      ...
      i.forEach(e => {
        ...
        if (
          !(
            e.validator ||
            e.plugin ||
            (e.rule && Object.values(a).includes(e.rule))
          )
        )
          throw Error(
            `Rule should be one of these types: ${Object.values(a).join(
              ', ',
    ...
    addRequiredGroup(e, i, t, s) {
      ...
      return (
        (this.groupFields[a] = {
          rules: [{ rule: n.Required, errorMessage: i, successMessage: s }],
          groupElem: l,
          elems: o,
          touched: !1,
          isValid: void 0,
    ...
    renderGroupLabel(e, i, t, s) {
      (!s && this.renderErrorsContainer(i, t)) || e.appendChild(i);
    }
    renderFieldLabel(e, i, t, s) {
      var l, r, o, a, n, d, c;
      if (s || !this.renderErrorsContainer(i, t))
  ...
  !(function (e) {
    ...
    ymaps.ready(function () {
      var e = new ymaps.Map('map', {
        ...
        i = new ymaps.GeoObject({
          geometry: { type: 'Point', coordinates: [55.8, 37.8] },
        });
      e.behaviors.disable('scrollZoom');
      const t = new ymaps.Placemark(
        [55.76035256508636, 37.614690103118896],
        {},
        {
      ...
      e.geoObjects.add(i),
        ...
        t.events.add('click', function () {
          const e = document.querySelector('.contacts__address-btn'),
            i = document.querySelector('.contacts__address');
  ...
  const m = document.querySelector('.search__btn-open'),
    v = document.querySelector('.search__btn-closed'),
    p = document.querySelector('.search__form');
  m &&
    m.addEventListener('click', function (e) {
      m.classList.toggle('active'), p.classList.toggle('active');
    }),
    v &&
      v.addEventListener('click', function (e) {
        m.classList.remove('active'), p.classList.remove('active');
      });
  const y = document.querySelector('body'),
    F = document.querySelector('.header__nav'),
    C = document.querySelector('.header__burger'),
    L = document.querySelectorAll('.nav__link');
  if (
    (C &&
      C.addEventListener('click', function (e) {
        y.classList.toggle('lock'),
